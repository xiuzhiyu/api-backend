...
import com.yupi.project.model.dto.userinterfaceinfo.UserInterfaceInfotUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    @PostMapping("/update")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> updateUserInterfaceInfo(@RequestBody UserInterfaceInfotUpdateRequest userInterfaceInfoUpdateRequest,
